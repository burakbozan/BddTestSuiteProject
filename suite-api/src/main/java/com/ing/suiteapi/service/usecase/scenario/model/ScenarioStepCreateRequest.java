...
@JsonSerialize
public class ScenarioStepCreateRequest {
    ...
    public ScenarioStepCreateRequest(Long scenarioId, List<ScenarioParametersDto> scenarioParametersDtoList, List<ScenarioStepsDto> scenarioStepsDtoList) {
